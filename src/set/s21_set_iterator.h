#ifndef CPP2_S21_CONTAINERS_2_SRC_SET_S21_SETITERATOR_H_
#define CPP2_S21_CONTAINERS_2_SRC_SET_S21_SETITERATOR_H_
...
class SetIterator {
 public:
  ...
  explicit SetIterator(node_type other) : node_(other) {}
  ...
  bool operator==(const SetIterator& other) { return node_ == other.node_; }
  bool operator!=(const SetIterator& other) { return node_ != other.node_; }
...
#endif  // CPP2_S21_CONTAINERS_2_SRC_SET_S21_SETITERATOR_H_